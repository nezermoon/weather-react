...
function Content({ cityName, setCity, showCityWeather, forecastCity, setForecastCity, showWeatherForecast }) {
	return (
...
function LeftSide({ cityName, setCity, forecastCity, setForecastCity, showWeatherForecast }) {
...
function RightSide({ cityName, setCity, showCityWeather, forecastCity, setForecastCity }) {
